...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_printf_parse_modifiers.c                        :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: jtaylor <marvin@42.fr>                     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/01/24 22:52:07 by jtaylor           #+#    #+#             */
/*   Updated: 2019/02/12 17:01:55 by jtaylor          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_length(const char *format, t_struct *f)
{
	if (ft_strchr("hljzL", format[f->i]))
	{
		...
		else if (format[f->i] == 'l')
		{
			...
			f->length = 7;
		while (ft_strchr("hljzL", format[f->i]))
			f->i++;
	}
}
